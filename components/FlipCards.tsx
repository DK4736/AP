...
const cards: Card[] = [
  {
    ...
    message: 'I don’t know when it happened… but you became my favorite part of everything, Умишкам мая 😘',
  ...
  },
  {
    ...
    message:
      "You don’t even try, yet you make my world feel softer, warmer, and somehow… complete ✨",
  ...
  },
  {
    ...
    message:
      "It’s the little things about you — your smile, your voice, the way you exist… somehow they’ve all become everything to me 🌸",
    ...
    <div className="page-container font-display relative min-h-screen flex flex-col items-center justify-center px-3 sm:px-4 md:px-6 py-2 sm:py-4">
                    ...
                    <div className="absolute w-full h-full bg-white rounded-lg border-2 border-pink-200 shadow-lg rotate-y-180 backface-hidden p-3 sm:p-4 flex flex-col justify-center">
                      <div className="text-center space-y-2 h-full flex flex-col justify-center">
                        <div className="flex-1 flex items-center justify-center">
                          <div className="text-xs sm:text-sm leading-relaxed text-[#1b0d14] px-1">
                            {card.message}
                          </div>
                        </div>
                        <div className="pt-1">
                          <div className="px-2 py-1 bg-pink-50 rounded-full text-xs font-medium text-[#9a4c73] border border-pink-100 inline-block">
                            Tap to flip back
                          </div>
                        </div>
                      </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-5 sm:p-6 max-w-sm w-full shadow-2xl border-2 border-pink-200">
            <div className="text-center space-y-3 sm:space-y-4">
              ...
              <div className="space-y-2.5 pt-1">
                <button
                  ...
                  className="w-full px-5 py-2.5 rounded-full bg-[#f04299] text-white font-semibold"
                >
                  Open the Final Letter 💌
                </button>
                <button
                  onClick={handleStayHere}
                  className="w-full text-xs text-[#9a4c73]"
                >
